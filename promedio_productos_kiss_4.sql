...
-- ====================================================================
-- ANÁLISIS: PROMEDIO DE PRODUCTOS POR ORGANIZACIÓN Y CATEGORÍA
-- ====================================================================

SELECT 'EJECUTANDO ANÁLISIS: PROMEDIO DE PRODUCTOS POR ORGANIZACIÓN' as proceso;

-- Consulta directa sin tabla temporal - Agrupado por cIDR y categoría
SELECT 
    CASE 
    ...
    END as organizacion,
    categoria,
    ROUND(AVG(productos_por_trimestre), 2) as promedio_productos,
    MIN(productos_por_trimestre) as min_productos,
    MAX(productos_por_trimestre) as max_productos
FROM (
    SELECT 
        categoria,
        cIDR,
