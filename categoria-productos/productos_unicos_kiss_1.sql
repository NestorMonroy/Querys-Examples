...
-- ====================================================================
-- ANÁLISIS: PRODUCTOS ÚNICOS POR ORGANIZACIÓN Y TRIMESTRE
-- ====================================================================

SELECT 'EJECUTANDO ANÁLISIS: PRODUCTOS ÚNICOS POR ORGANIZACIÓN Y TRIMESTRE' as proceso;

-- Consulta directa sin tabla temporal - Agrupado por cIDR y trimestre
SELECT 
    CASE 
...
FROM (
    SELECT @Q1_nombre as trimestre, cIDR, producto_id
    FROM ventas_1
    ...
    SELECT @Q2_nombre as trimestre, cIDR, producto_id
    FROM ventas_2
    ...
    SELECT @Q3_nombre as trimestre, cIDR, producto_id
    FROM ventas_3
